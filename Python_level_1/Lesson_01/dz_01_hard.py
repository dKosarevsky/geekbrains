...
if 30 > age and 50 <= weight <= 120:
    print('Вы в хорошем состоянии!', last_name, name)
elif 40 < age and 50 > weight or weight > 120:
    print('Вам требуется врачебный осмотр!', name)
elif 30 < age and 50 > weight or weight > 120:
    print('Вам требуется начать вести правильный образ жизни', name)
else:
    print('Хех...')
